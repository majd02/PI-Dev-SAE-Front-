...
@Component({selector: 'app-eventbacktri',
templateUrl: './eventbacktri.component.html',
styleUrls: ['./eventbacktri.component.css']
})
export class EventbacktriComponent implements OnInit {
public events!:any[];  
event:any = new Event(); 
title ='pagination';
page: number=1;
...
public getEvents():void{
  this.eventservice.getEventtri().subscribe(
    (response:any[])=>{
